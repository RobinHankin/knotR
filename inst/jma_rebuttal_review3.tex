...
\textcolor{blue}{I have not implemented sliders.  The weightings may
  be changed in function {\tt badness()}, and documentation (including
  examples) is given at {\tt badness.Rd}.\\ \\}
...
\textcolor{blue}{New figure added (Figure 6) which illustrates the implementation}
...
\textcolor{blue}{The referee is correct to say that changing the
  ...
  I have polled my colleauges who appear to be evenly split between
