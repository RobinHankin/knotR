...
In this short article I show how to create two dimensional knot
diagrams optimized for visual appearance using the R programming
language.  The package associated with this paper is a suite
of software for the creation of production-quality artwork of knot
diagrams, released under GPL2.
\end{abstract}
...
over another.  Related work in the same language is given by Comoglio
and Rinaldi~\cite{comoglio2011,comoglio2012}; the visual depiction of
knot projections in the context of Celtic artwork is given by
Browne~\cite{browne2005,browne2006}.
...
The software discussed here~\cite{hankin2016} allows one to specify a
...
\end{verbatim}
\begin{centering}
\includegraphics{knot-7_6_rough}
...
\end{verbatim}
  \centering
\includegraphics{knot-k76_knotplot2}
